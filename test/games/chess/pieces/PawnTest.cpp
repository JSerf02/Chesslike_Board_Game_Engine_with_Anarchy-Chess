...
TEST_CASE("Pawn: Attack")
{
    ...
    ChessPiece* blackPawn  = new Pawn(          Player::black, std::make_pair(3, 7));
    ChessPiece* whiteBlock = new TestChessPiece(Player::white, std::make_pair(2, 4));
    board->addPieces({whitePawn, blackPawn, whiteBlock});
    ...
    TestChessHelpers::testPieceAttacks(chessState, Player::black, validAttacks2);
...
TEST_CASE("Pawn: En Passant")
{
    ...
    ChessPiece* blackEnPassant2  = new Pawn(Player::black, std::make_pair(1, 4));
